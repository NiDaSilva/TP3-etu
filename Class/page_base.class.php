...
class page_base {
	...
	private $style=array('styles');
	private $script=array('TP2JS','jsFormation');
	private $titre;
	private $corps;
...
public function __get($propriete){
	...
	private function affiche_script() {
		...
		echo "<script src='http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.14/jquery-ui.min.js' type='text/javascript'></script>\n";
	...
	private function affiche_pied_page() {
		echo '<footer>copyright Lycée Chevrollier - 2TSSIOD 2015</footer>	'; ;
		}
	...
	<meta charset="UTF-8" />
	<meta name="keywords" lang="fr" content="BTS,SIO,javascript, Ajax, listes liées" />
	<meta name="description" content="Liées des listes déroulantes" />
